...
return [
    ...
    'timestamp' => 1448728775,
    'checksum' => '2de8c73444a1c024636e9af2d76df7e6',
    'files' => [
        'system/languages' => [
            'cs' => [
        ...
        'user/plugins' => [
            'plugins/admin' => [
                'file' => 'user/plugins/admin/languages.yaml',
                'modified' => 1448727638
            ],
            'plugins/form' => [
...
```',
        ...
        'fr' => [
            'PLUGIN_ADMIN' => [
                ...
                'APPEND_URL_EXT' => 'Ajouter l\'extension URL',
                'APPEND_URL_EXT_HELP' => 'Ajoutera une extension personnalisée à l\'URL de la page. Notez que cela signifie que Grav regardera le modèle d\'affichage `<modele>.<extension>.twig`'
            ],
            'PLUGIN_FORM' => [
            ...
            'LOGIN_PLUGIN' => [
                ...
                'LOGIN_FAILED' => 'Echec de la connexion...',
                'LOGIN_SUCCESSFUL' => 'Vous avez été connecté avec succès.',
                'BTN_LOGIN' => 'Connexion',
...
```',
        ...
        'hu' => [
            'PLUGIN_ADMIN' => [
                ...
                'OF_THIS_PLUGIN_IS_NOW_AVAILABLE' => 'ebbőll pluginból elérhető',
                'AUTHOR' => 'Alkotó',
                'HOMEPAGE' => 'Honlap',
                'DEMO' => 'Demó',
                'BUG_TRACKER' => 'Hibakövető',
                ...
                'DEFAULT_AUTHOR' => 'Alapértelmezett Alkotó',
                'DEFAULT_AUTHOR_HELP' => 'Egy alapértelmezett alkotói név, témákban valamint a lapokban többször előfordul',
                ...
                'UPDATES_ARE_AVAILABLE' => 'frissítések elérhetőek',
            ...
            'LOGIN_PLUGIN' => [
                ...
                'OAUTH_PROVIDER_NOT_SUPPORTED' => 'Az "%s" OAuth szolgáltató nem használható',
                'OR' => 'vagy',
                'PLUGIN_STATUS' => 'Plugin állapota',
